...
<head>
  ...
  <title>Gestion Projet | Modifier Chéf</title>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="validation1">Chéf</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control" id="validation2" name="competences" value="<%=rs.getInt("competences") %>"  placeholder="Nombre des années de competence" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <% }  %>
