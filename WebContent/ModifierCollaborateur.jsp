...
<% 
...

    {
        ...
        pst = con.prepareStatement("update collaborateur set nom=?,profil=?,tel=?,prenom=? where code = ?");
        pst.setString(1, nom);
        ...
        pst.setInt(5, id);
        pst.executeUpdate();
        response.sendRedirect("Collaborateurs.jsp?test=1");
    }
   %>
        <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <a href="Collaborateurs.jsp" class="btn btn-warning btn-rounded">Retour</a>
            <h1 class="h3 mb-0 text-center">Modifier Collaborateurs</h1>
          ...
          <form action="#" method="post">
             <%    
                        ...
                        pst = con.prepareStatement("select * from collaborateur where code = ?");
                        pst.setInt(1, id);
                        rs = pst.executeQuery();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validation1" name="nom" placeholder="Nom" value="<%= rs.getString("nom")%>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="validation2">Prénom</label>
                                                                <input type="text" class="form-control" id="validation2" name="prenom" value="<%= rs.getString("prenom")%>" placeholder="Prénom"required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="validation112">Téléphone</label>
                                                                <input type="number" class="form-control" name="tel" value="<%= rs.getString("tel")%>" placeholder="Téléphone" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="validation4">Profil</label>
                                                                <input type="text" class="form-control" id="validation4" name="profil" value="<%= rs.getString("profil")%>" placeholder="Profil"required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <% }  %>
