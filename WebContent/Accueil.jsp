...
<head>
  ...
  <title>Gestion Projet | Accueil</title>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Projets</div>
                      <%   Connection con;
                       PreparedStatement pst;
                       ResultSet rs;
                       Class.forName("com.mysql.jdbc.Driver");
                       con = DriverManager.getConnection("jdbc:mysql://localhost/gestion_mession?useSSL=false","root","");
                       pst = con.prepareStatement("select count(*) as total from projet");
                       rs = pst.executeQuery();
                                    
                      while(rs.next())
                       {
                      %>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=rs.getString("total") %></div>
                     <%
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Collaborateurs</div>
                      <%
                       Class.forName("com.mysql.jdbc.Driver");
                       con = DriverManager.getConnection("jdbc:mysql://localhost/gestion_mession?useSSL=false","root","");
                       pst = con.prepareStatement("select count(*) as total from Collaborateur");
                       rs = pst.executeQuery();
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">chefs</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                        <%
                       Class.forName("com.mysql.jdbc.Driver");
                       con = DriverManager.getConnection("jdbc:mysql://localhost/gestion_mession?useSSL=false","root","");
                       pst = con.prepareStatement("select count(*) as total from chefprojet");
                       rs = pst.executeQuery();
                                    
                      while(rs.next())
                       {
                      %>
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><%=rs.getString("total") %></div>
                     <%
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <%
                       Class.forName("com.mysql.jdbc.Driver");
                       con = DriverManager.getConnection("jdbc:mysql://localhost/gestion_mession?useSSL=false","root","");
                       pst = con.prepareStatement("select count(*) as total from gestionnaireprojet");
                       rs = pst.executeQuery();
