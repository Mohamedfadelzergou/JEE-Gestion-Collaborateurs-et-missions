...
<head>
  ...
  <title>Gestion Projet | 	Modifier Projets</title>
...
<% 
...

    {
        ...
        pst = con.prepareStatement("update projet set intitule=? where idprojet = ?");
        pst.setString(1, intitule);
        pst.setInt(2, id);
        pst.executeUpdate(); 
        response.sendRedirect("Projets.jsp?test=1"); 
   ...
   %>
        ...
        <div class="container-fluid">
          ...
          <a href="Missions.jsp" class="btn btn-primary btn-rounded">Retour</a>
            <h1 class="h3 mb-0 text-center">Modifier Projet</h1>
          ...
          <form action="#" method="post">
             <%    
                        ...
                        pst = con.prepareStatement("select * from projet where idprojet = ?");
                        pst.setInt(1, id);
                        rs = pst.executeQuery();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validation1" name="intitule" value="<%=rs.getString("intitule") %>" placeholder="intitule" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <% }  %>
