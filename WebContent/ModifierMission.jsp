...
<head>
  ...
  <title>Gestion Projet | 	Modifier Missions</title>
...
<% 
...

    {
        ...
        pst = con.prepareStatement("update mission set objectif=? where code_mission = ?");
        pst.setString(1, objectif);
        pst.setInt(2, id);
        pst.executeUpdate(); 
        response.sendRedirect("Missions.jsp?test=1"); 
   ...
   %>
        ...
        <div class="container-fluid">
          ...
          <a href="Missions.jsp" class="btn btn-primary btn-rounded">Retour</a>
            <h1 class="h3 mb-0 text-center">Modifier Mission</h1>
          ...
          <form action="#" method="post">
             <%    
                        ...
                        pst = con.prepareStatement("select * from mission where code_mission = ?");
                        pst.setInt(1, id);
                        rs = pst.executeQuery();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validation1" name="objectif" value="<%=rs.getString("objectif") %>" placeholder="objectif" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <% }  %>
