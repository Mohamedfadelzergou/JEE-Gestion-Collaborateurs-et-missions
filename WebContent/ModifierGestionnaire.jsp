...
<head>
  ...
  <title>Gestion Projet | Modifier Géstionnaire</title>
...
<% 
...

    {
        ...
        pst = con.prepareStatement("update gestionnaireprojet set nombreProjGere=? where code = ?");
        pst.setInt(1, nombreProjGere);
        pst.setInt(2, id);  
        pst.executeUpdate();
        response.sendRedirect("Gestionnaires.jsp?test=1");
        %>
   ...
   %>
        ...
        <div class="container-fluid">
          ...
          <a href="Gestionnaires.jsp" class="btn btn-warning btn-rounded">Retour</a>
            <h1 class="h3 mb-0 text-center">Modifier Géstionnaire</h1>
          ...
          <form action="#" method="post">
             <%    
                        ...
                        pst = con.prepareStatement("select * from gestionnaireprojet inner join collaborateur where gestionnaireprojet.code = collaborateur.code and gestionnaireprojet.code = ?");
                        pst.setInt(1, id);
                        rs = pst.executeQuery();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="validation1">Géstionnaire</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control" id="validation2" name="nombreProjGere" value="<%=rs.getInt("nombreProjGere") %>" placeholder="Nombre des projets Gére" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <% }  %>
